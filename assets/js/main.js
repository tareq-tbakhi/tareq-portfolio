...
const sendEmail = (e) =>{
    ...
    emailjs.sendForm('service_fi0oypw', 'template_bibmruv', '#contact-form', 'C_prRuTdDWBgyPZTW')
...
function changeImageBasedOnColorScheme() {
    if (document.body.classList.contains(darkTheme)) {
        ...
        themeImage.src = "assets/img/lang-white.png";
    } else {
        // Light mode detected, use the default light mode image
        themeImage.src = "assets/img/lang-black.png";
    }
}
